const ASL_YES = (ref) => {
  ...
  animations.push(["mixamorigRightHandThumb1", "rotation", "x", Math.PI / 5.5, "+"]);
  animations.push(["mixamorigRightHandThumb2", "rotation", "y", -Math.PI / 3, "-"]);
  animations.push(["mixamorigRightArm", "rotation", "x", -Math.PI / 3.6, "-"]);
  animations.push(["mixamorigRightArm", "rotation", "z", Math.PI / 3.9, "-"]);
